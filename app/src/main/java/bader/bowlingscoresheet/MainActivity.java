    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                rowAdapter.add(new ScoresRow());
            }
        });

        rowRecyclerView = (RecyclerView) findViewById(R.id.my_recycler_view);

        // use a linear layout manager
        rowLayoutManager = new LinearLayoutManager(this);
        rowRecyclerView.setLayoutManager(rowLayoutManager);

        ArrayList<ScoresRow> myDataset = new ArrayList<>();
        rowAdapter = new RowAdapter(myDataset);
